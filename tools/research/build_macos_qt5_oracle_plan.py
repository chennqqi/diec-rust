...
SOURCE_PATHS = (
    ...
    "tools/upstream/collect_macos_cli_filesystem.py",
    "tools/upstream/collect_macos_cli_privilege_paths.py",
    "tools/upstream/collect_macos_cli_large_directory.py",
    "tools/upstream/collect_macos_cli_long_paths.py",
    ...
    "tools/upstream/collect_macos_cli_special_paths.py",
    "tools/upstream/collect_macos_cli_toctou.py",
    "tools/upstream/collect_macos_database_cache_harness.py",
    "tools/upstream/database_cache_harness_macos_adapter.cpp",
    "tools/upstream/database_cache_harness_main.cpp",
    "tools/upstream/exec_macos_privilege_root.py",
    ...
    "tools/upstream/validate_macos_cli_filesystem.py",
    "tools/upstream/validate_macos_cli_privilege_paths.py",
    "tools/upstream/validate_macos_cli_large_directory.py",
    "tools/upstream/validate_macos_cli_long_paths.py",
    ...
    "tools/upstream/validate_macos_cli_special_paths.py",
    "tools/upstream/validate_macos_cli_toctou.py",
...
def build_plan(root: Path) -> dict[str, Any]:
    ...
    return {
        ...
        "dispatch_workflow": {
            ...
            "filesystem_path_fixture_candidate": True,
            "privilege_path_cli_candidate": True,
            "large_directory_fixture_candidate": True,
            "long_path_fixture_candidate": True,
            "toctou_cli_candidate": True,
            "database_cache_engine_candidate": True,
            ...
            "special_path_cli_execution_count": 46,
            "filesystem_cli_execution_count": 16,
            "privilege_path_cli_execution_count": 24,
            "large_directory_cli_execution_count": 10,
            "long_path_cli_execution_count": 34,
            "toctou_cli_execution_count": 8,
            "general_cli_execution_count": 2132,
            "general_cli_raw_stream_count": 4264,
            "engine_cache_execution_count": 2,
            "engine_cache_raw_stream_count": 4,
            "build_raw_stream_count": 2,
            "candidate_runtime_execution_count": 2134,
            "candidate_runtime_raw_stream_count": 4268,
        },
        "runtime_closure": {

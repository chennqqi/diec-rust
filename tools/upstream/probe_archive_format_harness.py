...
def build_report(
    ...
    bcj_aes_path = "/fixture/pdf-member-bcj-lzma2-aes.7z"
    arm64_aes_path = "/fixture/pdf-member-arm64-lzma2-aes.7z"
    ...
    for (
        ...
        (
            ...
            ("--password", SEVENZIP_AES_PASSWORD, bcj_aes_path),
            True,
            True,
            331,
            pdf_sha256,

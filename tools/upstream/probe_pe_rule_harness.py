#!/usr/bin/env python3
"""Run and verify the pinned Qt5 PE fixed-rule oracle harness."""
...
RULE_PATH = "/opt/die-source/Detect-It-Easy/db/PE/compiler_Cygwin32.4.sg"
...
def validate(
    ...
    if set(fixture_by_id) != set(EXPECTED):

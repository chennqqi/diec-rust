#!/usr/bin/env python3
"""Run and verify the pinned Qt5 Mach-O fixed-rule oracle harness."""
...
RULE_PATH = "/opt/die-source/Detect-It-Easy/db/MACH/compiler_Rust.4.sg"
...
def validate(
    ...
    for case_id in EXPECTED_IDS:
        ...
        expected_detections = (
            [["compiler", "Rust", "", ""]] if is_match else []
        )

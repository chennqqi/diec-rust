...
class CapabilityCoverageTest(unittest.TestCase):
    ...
    def test_all_capabilities_and_platform_cells_are_classified(self):
        ...
        self.assertEqual(summary["rows_with_corpus_gaps"], 0)
    ...
    def test_linux_runtime_and_source_only_counts_are_not_conflated(self):
        ...
        self.assertEqual(linux["runtime_observed"], 68)
        self.assertEqual(linux["runtime_observed_with_corpus_gaps"], 0)
        self.assertEqual(
        ...
        self.assertEqual(
            rows["CAP-CLI-IN-003"]["platform_status"][
                "linux-x86_64-qt5"
            ],
            "runtime_observed",
        )
        self.assertEqual(rows["CAP-CLI-IN-003"]["corpus_gap_ids"], [])

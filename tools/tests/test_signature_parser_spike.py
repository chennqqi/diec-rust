...
class SignatureParserSpikeTests(unittest.TestCase):
    ...
    def test_compatibility_mode_is_explicitly_scoped(self):
        ...
        self.assertEqual(
            spike["pinned_binary_script_search_differential"],
            {
                "case_count": 4,
                "matched_count": 4,
                "methods": [
                ...
                "oversized_range_clamp_observed": True,
                "size_minus_one_to_eof_observed": True,
            },
        )
        self.assertEqual(
    ...
    def test_signature_oracle_provenance_matches_files(self):
        ...
        self.assertEqual(oracle["binary_script_string_context_case_count"], 15)
        self.assertEqual(
            oracle["binary_script_execution_context_case_count"], 3
        )
        self.assertEqual(oracle["binary_script_text_prefill_case_count"], 4)
        self.assertTrue(oracle["non_unicode_uninitialized_state_observed"])

...
| API | source/request/limits/cancel/report/diagnostic、legacy/modern 分离 | ADR 0003、modern schema、limits、thread/path policy |
| C ABI | opaque handle、布局、状态、所有权、panic、thread/static link | ADR 0001、runtime thread model、三平台和 Go/Python 验证 |
| Testing | capability/raw/semantic/waiver、fuzz、FFI、performance、CI/release | ADR 0004、Windows/macOS oracle、Rust 成对/cold/size benchmark、limits、release integration |

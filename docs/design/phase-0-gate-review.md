...
| `P0-BLOCK-005` | Open | 68 行 × 4 平台 coverage report 已建立且无未分类 cell；Linux source-only 已清零，CAP-GAP-001/002/004/009/010/011/012 已由 CLI 专用模式、database cache/权限、formatter 边界、device、规则排序、取消和七类 Image oracle 闭合；仍有 11 个 corpus-gap 行及三个平台各 68 个 platform-missing |

...
| `P0-BLOCK-004` | Open | 固定 Linux Qt5 CMake `diec` 已闭合为 223 direct + 14 archive = 237 个 compile source，绑定 13 组件、AUTOMOC、14 根 LICENSE 和 byte-identical GNU ld map；其中 XArchive 为 84 direct + 1/22 archive source，XCapstone 为 1 direct + 10/11 archive source，XSIMD 为 3/3；全局清单新发现 direct-link XUCL 的 GNU GPL 声明引用缺失 `ACC_LICENSE`。runtime `db*` 2,268 文件、22 PNG 来源、RAR/UnRAR 差异和 MIT/BSD/LLVM-NCSA 文本已有技术证据；仍需 XUCL 官方来源/许可证、artwork 授权、RAR decoder 条款、跨平台/发布包 closure 和发布责任人书面评审 |

...
| `P0-BLOCK-005` | Open | 68 行 × 4 平台 coverage report 已建立且无未分类 cell；Linux source-only 已清零，CAP-GAP-001/002/004/005/009/010/011/012 已闭合；CAP-GAP-006 已固定 100000-record 及 ZIP deflate/ZipCrypto/1 MiB high-ratio/首轮 malformed 子矩阵；仍有 8 个 corpus-gap 行及三个平台各 68 个 platform-missing |

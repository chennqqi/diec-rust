...
- **当前证据**：固定 Linux Qt5 archive oracle 已在 256 MiB/1 CPU/30 s 外部边界
  ...
  Copy/LZMA/LZMA2/BZip2/Deflate 五种 coder、BCJ+LZMA2 filter 链与 CAB
  Store/MSZIP 都能到达 PDF child；未覆盖的 PPMd7/Deflate64、
  ARM64-BCJ/BCJ2/AES、CAB LZX/Quantum 与其他 backend 仍需共享同一预算。详见

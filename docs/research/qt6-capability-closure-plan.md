...
首组 Qt6 engine harness、规则编排、result-model、signature-path 和
debug-dispatch harness 已完成。后续应按机器清单继续复用既有 Qt5 fixture，
集中关闭其余 dispatch、nested/archive 和复杂目录边界。

...
8-case Junction/扩展命名空间矩阵。六批共 918 次执行均稳定；默认 detection
...
[`windows-filesystem-behavior.md`](windows-filesystem-behavior.md)。由于 UNC、
真实长路径、symlink/reparse cycle/ACL 等边界、database

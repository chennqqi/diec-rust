...
相等；全部平台 cell 有已知状态；Linux 四类计数保持 42/20/5/1；其他三个平台
...
1. 按
   ...
   为 6 个 Linux source-only 能力建立固定 runtime corpus 或评审 scope；

...
7Z Copy/LZMA/LZMA2/BZip2/Deflate、x86 BCJ+LZMA2、ARM64-BCJ+LZMA2 BL、
...
- `CAP-NEST-003`：archive 解包由独立 `bIsArchivesScan` 控制，发布 CLI 不设置它；ZIP 和
  ...
  证明五种 7Z 单 coder、x86/ARM64-BL BCJ+LZMA2 filter 链、RAR4 store、CAB
...
- `CAP-NEST-009`：固定源码没有独立嵌套 depth 或全 scan 累计展开字节状态；
  ...
  x86 BCJ+LZMA2、ARM64-BCJ+LZMA2 BL、RAR4 store、CAB Store/MSZIP 与
  ISO9660 正例已经固定，但
...
- archive aggressive 100000、ZIP 1 MiB/843.58:1 与首轮压缩/加密/畸形边界
  ...
  五种 7Z 单 coder、x86/ARM64-BL BCJ+LZMA2 filter 链、RAR4 store、CAB

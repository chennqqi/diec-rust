...
同一固定 harness 的补充格式实验还运行五种 7Z coder、RAR4 store、CAB
Store/MSZIP 与 ISO9660 共九个项目生成的单 PDF 样本。九者 default 均与发布
CLI 原始输出相同且不展开；
...
| 7Z Copy/LZMA/LZMA2/BZip2/Deflate、RAR4 store、CAB Store/MSZIP、ISO→PDF / archive | 1 | 0 | 0 | 九个 coder/container 样本各产生一个 PDF Stream |

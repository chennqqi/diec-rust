...
同一固定 harness 的补充格式实验还运行五种 7Z 单 coder、x86/ARM64-BL
...
| 7Z Copy/LZMA/LZMA2/BZip2/Deflate/x86 BCJ+LZMA2/ARM64-BCJ+LZMA2 BL、RAR4 store、CAB Store/MSZIP、ISO→PDF / archive | 1 | 0 | 0 | 十一个 coder/container 样本各产生一个 PDF Stream |

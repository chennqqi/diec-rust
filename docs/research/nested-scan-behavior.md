...
同一固定 harness 的补充格式实验还运行五种 7Z 单 coder、BCJ+LZMA2 filter
链、RAR4 store、CAB Store/MSZIP 与 ISO9660 共十个项目生成的单 PDF 样本。
十者 default 均与发布
CLI 原始输出相同且不展开；
...
| 7Z Copy/LZMA/LZMA2/BZip2/Deflate/BCJ+LZMA2、RAR4 store、CAB Store/MSZIP、ISO→PDF / archive | 1 | 0 | 0 | 十个 coder/container 样本各产生一个 PDF Stream |

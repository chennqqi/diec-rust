...
| archive/resource/overlay 递归 | 无深度/总解压限制；CLI 与 engine 可达性不同；resource 为 21/2001，PE parser 每目录限 1000；RAR4/CAB/ISO9660 store 正例已固定 | 继续验证 7Z、100000、压缩/畸形边界和资源耗尽 |

...
| archive/resource/overlay 递归 | 无深度/总解压限制；CLI 与 engine 可达性不同；resource 为 21/2001，PE parser 每目录限 1000；archive 第 100000 条可达、第 100001 条不可达；7Z/RAR4/CAB/ISO9660 无压缩正例及 ZIP deflate/ZipCrypto/首轮畸形已固定 | 继续验证其他算法/格式、系统化畸形和资源耗尽 |

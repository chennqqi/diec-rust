...
Mach-O64 x86_64/arm64 Rust compiler、DEX035/QDBH 和 APK/ZIP QDBH
规则差分；当前 source SHA-256 为
`139d9f3fda2064e694c2eb5549c59ec27412243e42d11456ab123494f86c1f3c`。
两套工具链均通过 34 项测试，release 差分分别为 3/3、6/6、4/4、3/3 和
3/3，且未新增 Cargo 依赖。
